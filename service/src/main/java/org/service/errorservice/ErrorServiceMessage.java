...
public class ErrorServiceMessage {
	...
	public static final String NO_USER_RECORD = " this user id dont have any records";
	...
	// -------- Profile Invoice
	public static final String NO_PROFILE_INVOICE_RECORD = "There is no list of profile for this user id";
	public static final String NO_PROFILE_INVOICE_SAVED = "Sorry your profile invoice is not saved successfully!";
	public static final String INVALID_USER_WITH_INVOICE_DATE="Sorry this invoice date with same user is already available";
